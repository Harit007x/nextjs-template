...
export function SettingsProvider({ children }: { children: React.ReactNode }) {
  ...
  // Load settings from localStorage on mount (optional but good practice)
  useEffect(() => {
  ...
  useEffect(() => {
    // Apply theme color dataset to HTML so tailwind reads global theme changes
    document.documentElement.setAttribute('data-theme', themeColor);
  }, [themeColor]);

  return (
    <SettingsContext.Provider value={{ language, setLanguage, direction, themeColor, setThemeColor }}>
